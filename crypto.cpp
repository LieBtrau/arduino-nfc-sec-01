...
void NfcSec01::setRemotePublicKey(const byte* key)
{
...
bool NfcSec01::calcMasterKeySSE(const byte* pRemoteNonce, const byte* pRemoteNFCID3, byte nfcid3Length)
{
    const struct uECC_Curve_t * curve = uECC_secp192r1();
...
//    Serial.print("Shared secret: ");print(SharedSecret, _128BIT_);
    ...
    memset(_remoteNFCID3,0,NFCID_SIZE);
